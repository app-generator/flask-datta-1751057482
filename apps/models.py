...
class Students(db.Model):
    ...
    #__Students_FIELDS__
    esis = db.Column(db.Integer, nullable=True)
    name = db.Column(db.Text, nullable=True)
    email = db.Column(db.Text, nullable=True)
    homeroom = db.Column(db.Text, nullable=True)
    password = db.Column(db.Text, nullable=True)
    attendance_percentage = db.Column(db.Text, nullable=True)
    total_grade = db.Column(db.Text, nullable=True)
...
class Attendance(db.Model):
    ...
    teacher_id = db.Column(db.Text, nullable=True)
    class_id = db.Column(db.Text, nullable=True)
